...
module.exports = {
  ...
  resolve: {
    ...
    alias: Object.assign({}, pathMap, {
      ...
      agents: resolve("src/components/pages/agents"),
      dashBoard: resolve("src/components/pages/dashBoard"),
      myCruise: resolve("src/components/pages/myCruise"),
      help: resolve("src/components/pages/help"),
